...
<?php if (isset($_GET['preview'])):
    $h = Digest::highlights();
    $mail = Digest::buildEmail(
        ['id' => 0, 'email' => 'preview@ foot-boll.com', 'name' => $L('صلاح','Salah')],
...
<div class="admin-card" style="border-inline-start:4px solid <?= $hbStale ? '#dc2626' : '#16a34a' ?>">
  ...
  <?php if ($hbDigest === 0): ?>
    ...
    <pre style="background:#0a1626;padding:10px 14px;border-radius:8px;overflow:auto;direction:ltr;font-size:12px">php /home/USER/domains/ foot-boll.com/public_html/cron/digest.php</pre>
  <?php else: ?>
    <p>
