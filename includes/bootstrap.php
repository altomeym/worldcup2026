...
require __DIR__ . '/EspnLive.php';
require __DIR__ . '/LiveService.php';
require __DIR__ . '/Standings.php';
require __DIR__ . '/Stats.php';
require __DIR__ . '/TeamCompare.php';
require __DIR__ . '/DailyOpinion.php';
require __DIR__ . '/Insights.php';
require __DIR__ . '/FeaturedCups.php';
...
require __DIR__ . '/ArabicText.php';
require __DIR__ . '/TweetCardImage.php';
